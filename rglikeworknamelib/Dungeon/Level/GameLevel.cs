...
namespace rglikeworknamelib.Dungeon.Level {
    public class GameLevel
    {
        ...
        public void OpenCloseDoor(int x, int y) {
            ...
            if(BlockDataBase.Data[a.Id].SmartAction == SmartAction.ActionOpenClose) {
                if (BlockDataBase.Data[a.Id].IsWalkable) {
                    EventLog.Add("¬ы закрыли дверь", GlobalWorldLogic.CurrentTime, Color.Gray, LogEntityType.OpenCloseDor);
                }
                else {
                    EventLog.Add("¬ы открыли дверь", GlobalWorldLogic.CurrentTime, Color.LightGray, LogEntityType.OpenCloseDor);
        ...
        /// <param name="resx">–азмер квадрата, кастующего тень</param>
        /// <param name="resy">–азмер квадрата, кастующего тень</param>
        /// <returns></returns>

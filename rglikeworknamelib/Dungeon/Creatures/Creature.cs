...
namespace rglikeworknamelib.Dungeon.Creatures
{
    ...
    public class Creature {
        ...
        public virtual void Update(GameTime gt, MapSector ms_, Player hero, bool test = false) {
            ...
            creatureWorld.Translation = new Vector3(position_.X / 32f + ms.SectorOffsetX * MapSector.Rx, position_.Y / 32f + ms.SectorOffsetY * MapSector.Ry, 0) + new Vector3(0,0, 0.5f);

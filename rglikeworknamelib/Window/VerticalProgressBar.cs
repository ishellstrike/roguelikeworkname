...
namespace rglikeworknamelib.Window {
    public class VerticalProgressBar : IGameWindowComponent
    {
        ...
        public void Draw(SpriteBatch sb)
        {
            ...
            sb.Draw(whitepixel_, new Vector2(locate_.X + 3, locate_.Y + 3) + Parent.GetLocation(), null, Settings.Hud—olor, 0, Vector2.Zero, new Vector2((locate_.Width - 4), (locate_.Height - 4) * ((float)Progress / Max)), SpriteEffects.None, 0);
        }
